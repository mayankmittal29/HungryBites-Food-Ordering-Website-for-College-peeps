...
const Navbar = () => {
  return (
    <>
      <div className="navbar fixed top-0 left-0 right-0 z-10 bg-white shadow-md">
        <div className="flex max-w-[1240px] mx-auto items-center p-4 justify-between">
          <div className="cursor-pointer">
            <h1 className="font-bold text-3xl sm:text-4xl lg:text-4xl ">HungryBites</h1>
          </div>
          <div className="flex">
      ...
      <div className="navbar-placeholder h-20"></div> {/* Placeholder to prevent content from jumping */}
    </>
  );
};
